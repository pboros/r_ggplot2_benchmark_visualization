...
# sysbench_throughput
sysbench_tps<-subset(sysbench_oltp,metric=="sysbench_tps" & storage=='eXFlash DIMM_8')
...
tps_graph<-tps_graph+facet_grid(. ~ ro_rw)
...
ggsave(plot = tps_graph, "r_ggplot2_benchmark_visualization/ex13.png", dpi=200, scale=1, height=6, width=6, type = "cairo-png")
