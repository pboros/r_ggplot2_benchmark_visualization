...
# sysbench_throughput
sysbench_tps<-subset(sysbench_oltp,metric=="sysbench_tps" & ro_rw=="rw" & storage=='eXFlash DIMM_8')
...
ggsave(plot = tps_graph, "r_ggplot2_benchmark_visualization/ex12.png", dpi=200, scale=1, height=6, width=6, type = "cairo-png")
